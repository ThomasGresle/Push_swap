...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/22 20:16:22 by tgresle           #+#    #+#             */
/*   Updated: 2021/12/22 21:18:51 by tgresle          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			move_p(t_list *dest, t_list *src,
					char *move, t_move_list *list);
void			move_r(t_list *list, char *move,
